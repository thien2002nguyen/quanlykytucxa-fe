            ...
            <div className="wrapper-contract-room-page-my-contract">
              ...
              <div>
                ...
                <p>
                  ...
                  {
                    dataAuthMeStudent.data?.contractId?.studentInfomation
                      ?.nationalIdCard
                  }
                </p>
                <p>
                ...
                <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                  <div className="contract-infomation-room">
                    ...
                    <p>
                      ...
                      {formatVND(
                        dataAuthMeStudent.data?.roomId?.roomTypeId?.price || 0
                      )}{" "}
                      VNĐ
                    </p>
                  </div>
              ...
              <List
                ...
                dataSource={dataAuthMeStudent.data?.contractId?.service}
                renderItem={(item) => (
              ...
              <div>
                <p>
                  ...
                  {dataAuthMeStudent.data?.contractId?.contractType
                    ?.contractTypeId?.title || "Hợp đồng ký túc xá"}{" "}
                  - {dataAuthMeStudent.data?.contractId?.contractType?.duration}{" "}
                  {(dataAuthMeStudent.data?.contractId?.contractType?.unit ===
                    TimeUnitEnum.DAY &&
                    "Ngày") ||
                    (dataAuthMeStudent.data?.contractId?.contractType?.unit ===
                      TimeUnitEnum.MONTH &&
                ...
                <p>
                  ...
                  {dataAuthMeStudent.data?.contractId?.endDate
                    ? dayjs(dataAuthMeStudent.data?.contractId?.endDate).format(
                        "DD/MM/YYYY "
                      )
                    : "Hợp đồng chưa được duyệt"}
                </p>
              ...
              <div className="contract-infomation-term">
                <List
                  ...
                  size="small"
                  dataSource={dataAuthMeStudent.data?.contractId?.term}
                  bordered
